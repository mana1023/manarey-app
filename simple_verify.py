...
def verify_pending_increments():
    ...
    try:
        ...
        print("[OK] pending_increments table exists.")
        conn.close()
        return True
    except Exception as e:
        print(f"[FAIL] pending_increments table check failed: {e}")
        return False
...
def verify_increment_stock():
    ...
    try:
        ...
        if not row:
            print("[SKIP] No products found to test increment_stock.")
        ...
        if success:
            print(f"[OK] increment_stock succeeded: {msg}")
            return True
        else:
            print(f"[FAIL] increment_stock failed: {msg}")
            return False
    except Exception as e:
        print(f"[FAIL] increment_stock exception: {e}")
        return False
...
def verify_coalesce():
    ...
    try:
        ...
        print("[OK] _find_product query executed (no syntax error).")
        return True
    except Exception as e:
        print(f"[FAIL] _find_product query failed: {e}")
        return False
