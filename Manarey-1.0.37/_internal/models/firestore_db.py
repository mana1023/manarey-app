            ...
            return [
                {
                    ...
                    "precio_costo": r[10] if has_material else r[9],
                    "codigo": r[11] if has_material else r[10],
                    "descripcion": r[12] if has_material else r[11],
                    "updated_at": r[13] if has_material else r[12],
                    "created_at": r[14] if has_material else r[13],
                }
                for r in rows
            ]
    except Exception as e:
