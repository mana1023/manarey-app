        ...
        try:
                    ...
                    if isinstance(obj, QMainWindow):
                        ...
                        if screen:
                            ...
                            if self.app.property("manarey_auto_fit"):
                                target_w = int(geo.width() * 0.98)
                                target_h = int(geo.height() * 0.98)
                                try:
            ...
            if (
                ...
                try:
                    ...
                    # clamp shrink factor so UI doesn't become too small
                    factor = max(0.6, min(1.05, factor))
