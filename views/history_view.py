...
class MovementCard(QWidget):
    ...
    def __init__(self, parent, row_tuple, role, username, undo_cb):
        ...
        self.setStyleSheet(
            f"QWidget{{background:{_T('CARD', '#232327')}; border:1px solid {_T('BORDER', '#34343a')}; border-radius:12px;}}"
            f"QLabel{{color:{_T('TEXT', '#ECECF1')};}}"
        )
        ...
        title.setStyleSheet(f"color:{_T('GOLD', '#C9A040')}; font-weight:800;")
        ...
        if details_full:
            ...
            details_lbl.setStyleSheet(f"color:{_T('TEXT_MUTED', '#c9c9cf')};")
            ...
            if details_preview:
                ...
                btn.setStyleSheet(
                    f"QPushButton{{background:#34343a;color:{_T('GOLD', '#C9A040')};border:1px solid {_T('BORDER', '#34343a')};"
...
class ConfirmDialog(QDialog):
    def __init__(self, titulo, texto, detalle=None, parent=None):
        ...
        self.setStyleSheet(
            f"QDialog{{background:{_T('CARD', '#232327')}; color:{_T('TEXT', '#ECECF1')}; border:1px solid {_T('BORDER', '#34343a')}; border-radius:14px;}}"
            f"QLabel{{color:{_T('TEXT', '#ECECF1')};}}"
        )
        ...
        head.setStyleSheet(f"color:{_T('TEXT', '#ECECF1')}; font-weight:700;")
        lay.addWidget(head)
    ...
    def _setup_ui(self):
        ...
        if self.back_command:
            ...
            btn_back.setStyleSheet(
                f"QPushButton{{background:#34343a;color:{_T('GOLD', '#C9A040')};border:1px solid #3e3e44;"
        ...
        title.setStyleSheet(f"color:{_T('GOLD', '#C9A040')}; margin-left:8px;")
        top.addWidget(title)
        top.addStretch()
        root.addLayout(top)
        ...
        self.search.setStyleSheet(
            f"QLineEdit{{background:{_T('GOLD', '#C9A040')};color:#171717;border:none;border-radius:12px;padding:8px 12px;}}"
        )
        ...
        self.action_cb.setStyleSheet(
            f"QComboBox{{background:{_T('GOLD', '#C9A040')};color:#171717;border:none;border-radius:12px;padding:8px 12px;}}"
        )
        ...
        if self.role == "admin":
            ...
            self.local_cb.addItems(["Todos", *get_locales()])
        ...
        btn.setStyleSheet(
            f"QPushButton{{background:{_T('GOLD', '#C9A040')};color:#171717;border:none;border-radius:12px;padding:9px 16px;font-weight:700;}}"
        )
